    ...
    <motion.nav initial={{ opacity: 0 }} animate={{ opacity: 1 }} id="nav" className="sm:container sm:mx-auto">
      <div className="z-10 max-w-screen-lg xl:max-w-screen-xl block sm:flex sm:justify-between sm:items-center py-6">
        ...
        <div className="flex justify-between items-center px-4 sm:px-0">
          ...
          <div onClick={() => setTheme(activeTheme)} aria-label="Theme Switcher" className="block sm:hidden ml-0 bg-primary-light dark:bg-ternary-dark p-3 shadow-sm rounded-xl cursor-pointer">
        ...
        <div className={showMenu ? "block m-0 sm:ml-4 bg-fuchsia-200 mt-5 sm:mt-3 sm:flex p-5 sm:p-0 justify-center items-center shadow-lg sm:shadow-none" : "hidden"}>
          ...
          <Link to="/about" className="block text-left text-lg text-primary-dark dark:text-ternary-light hover:text-secondary-dark dark:hover:text-secondary-light  sm:mx-4 mb-2 sm:py-2 border-t-2 pt-3 sm:pt-2 sm:border-t-0 border-primary-light dark:border-secondary-dark" aria-label="About Me">
            About Me
          </Link>
        </div>
        ...
        <div className="hidden sm:flex justify-between items-center flex-col md:flex-row">
          ...
          <div onClick={() => setTheme(activeTheme)} aria-label="Theme Switcher" className="ml-8 bg-primary-light dark:bg-ternary-dark p-3 shadow-sm rounded-xl cursor-pointer">
            {activeTheme === "dark" ? <FiMoon className="text-ternary-dark hover:text-gray-400 dark:text-ternary-light dark:hover:text-primary-light text-xl" /> : <FiSun className="text-gray-200 hover:text-gray-50 text-xl" />}
          </div>
        </div>
      </div>
